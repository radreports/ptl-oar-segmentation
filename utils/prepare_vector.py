...
class LoadPatientVolumes(Dataset):
    def __init__(self, image_data, data_config, external=False):
        """
    ...
    def load_data(self, idx):
        ...
        Loading of the data...
        """
        self.img_path = str(self.data.iloc[idx][0])
        self.structure_path = str(self.data.iloc[idx][1])
        # assumes directory structure where patient name is enclosing folder...
        self.patient = img_path.split("/")[-2]
