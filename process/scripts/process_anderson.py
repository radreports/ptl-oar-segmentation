...
def add_args(return_="parser"):
    ...
    arg("--output", default="/cluster/projects/radiomics/EXTERNAL/TCIA-HNSCC/", help="Output path as...?")
...
def main(outputPath, exception_dict):
    ...
    print(results)
    # save logs
    info, info2, problem = Info(ending='TCIA_FOUND'), Info(ending='TCIA_ORIG'), BadFiles()
