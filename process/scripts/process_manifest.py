...
def add_args(return_="parser"):
    ...
    arg("--input", default="/cluster/projects/radiomics/EXTERNAL/manifest-1549495779734/HNSCC-3DCT-RT", help="Input path as...?")
    arg("--output", default="/cluster/projects/radiomics/EXTERNAL/HNSCC-3DCT-RT", help="Output path as...?")
...
def main(outputPath, exception_dict):
    ...
    data = pd.read_csv('/cluster/home/jmarsill/Temp/manifest_ref.csv', index_col=0)
    # data = load_obj('/cluster/home/jmarsill/mastro.pkl')
    done = glob.glob('/cluster/projects/radiomics/EXTERNAL/HNSCC-3DCT-RT/*')
    ...
    print(results)
    # save logs
    info, info2, problem = Info(ending='MANFOUND'), Info(ending='MANORIG'), BadFiles()
