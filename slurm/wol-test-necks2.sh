...
model_name='WOLNET_2023_04_12_141555' #'WOLNET_2023_01_31_190855' # allows us to reload from previous settings...
...
gamma=0.985 # 0.975 # decay lr by this factor...
decay_after=1 # 15# 100 # 250 # decay lr after 4 epochs...
shuffle=True
classes=7 # 19 # number of classes (to test on), PAN HNSCC GTV/CTV... (Do we need/want that?)
...
path="/cluster/home/jmarsill/ptl-oar-segmentation/test_necks.py" #train_2 if training new model
